            ...
            <div class=" grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 p-6 w-full ">
                ...
                <router-link to="/my/nomor/selesai">
                    <div
                        ...
                        <div class="text-center">
                            <h2 class="text-2xl font-bold text-yellow-900">Naskah Direview</h2>
                ...
                <router-link to="/my/nomor/rejected">
                    <div
                        ...
                        <div class="text-center">
                            <h2 class="text-2xl font-bold text-red-900">Naskah Ditolak</h2>
                ...
                <router-link to="/my/arsip">
                    <div
                        ...
                        <div class="text-center">
                            <h2 class="text-2xl font-bold text-green-900">Naskah ACC</h2>
                ...
                <router-link to="/my/nomor/dibatalkan">
                    <div
                        ...
                        <div class="text-center">
                            <h2 class="text-2xl font-bold text-orange-900">Nomor Dibatalkan</h2>
                ...
                <router-link to="/my/nomor">
                    ...
                    <div
                        ...
                        <div class="text-center">
                            <h2 class="text-2xl font-bold text-gray-600">Belum Upload File</h2>
                ...
                <router-link to="/my/nomor/all">
                    <div
                        ...
                        <div class="text-center">
                            <h2 class="text-2xl font-bold text-sky-900">Total</h2>
...
const loadNomor = async () => {
    ...
    await axios.get("/api/user-nomor-all", {
        headers: {
