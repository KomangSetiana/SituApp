    ...
    <div class="bg-gray-100 flex h-screen">
        ...
        <div class="flex-1 flex flex-col  h-screen overflow-y-auto">
            <div class=" grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 p-6 w-full ">
                <!-- Card 1 -->
                <div class=" bg-white shadow-lg rounded-lg w-full h-48 flex items-center justify-center transform
            transition-transform duration-500 hover:scale-105 hover:shadow-xl hover:bg-yellow-200">
                ...
                <div class="relative inline-block">
                    ...
                    <button @mouseenter="showTooltip = true" @mouseleave="showTooltip = false"
                        class="px-3 py-2 bg-sky-800 text-white text-sm rounded-md shadow hover:bg-sky-600">
                        Create
                    </button>
...
const loadNomor = async () => {
    ...
    await axios.get("/api/user-nomor-selesai", {
        headers: {
